...
$$
E =  \lbrace v_i-v_j : \bar{x}_i \in top(k, \bar{x}_j) \text{ OR } \bar{x}_j \in top(k, \bar{x}_i)  \rbrace
$$
...
$$
E =  \lbrace v_i-v_j : \bar{x}_i \in top(k, \bar{x}_j) \text{ AND } \bar{x}_j \in top(k, \bar{x}_i) \rbrace
$$
