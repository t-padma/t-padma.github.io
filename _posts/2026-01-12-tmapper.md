...
**Step 2: Generate a simplified shape graph**
...
Additionally, each directed edge in $E_s$ is associated with a weight that measures the proportion of such connections. 
