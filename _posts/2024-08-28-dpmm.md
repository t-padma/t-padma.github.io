...
**Fig 3: Samples from Dirichlet distribution for different concentration parameter values**. Plots have been made using [Plotly's documentation](https://plotly.com/r/ternary-plots/) on ternery plots.
<p float="left">
  <img src="/images/ternery1.png" width = "400" />
  <img src="/images/ternery2.png" width = "400" /> 
</p>
