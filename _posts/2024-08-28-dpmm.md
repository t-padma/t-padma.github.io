...
| :--------------- | :----------------------------------- | :--------|
| $\rho_1 \sim Beta(\alpha_1, \alpha_2)$ <br> \rho_2 = 1 - \rho_1 <br>  \alpha_1, \alpha_2 >0   |   True   | abc |
| $\vec{\mathbf{\rho}} \sim Dir(\alpha_1, \alpha_2, \cdots, \alpha_K)$ <br> where $\alpha_i >0 \forall i = 1, \cdots, N$. <br>Then, $\vec{\rho}$  is $K $-dimensional and $\sum_{i=1}^K \rho_i = 1$ |   True   | 23.99 |
