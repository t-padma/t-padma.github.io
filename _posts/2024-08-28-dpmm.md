...
1. There are two common interpretations of mixture models: one is more probabilistic and the other is more analytic.
2. Bayesian vs frequentist mixtures (H random vs deterministic with unknown params)
