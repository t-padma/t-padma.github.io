...
6. The problem with finite mixtures, why do we need infinitely many components?'
7. Bayesian mixture model inference is of two types - within and across model sampling. Reversible jump MCMC is an example of across model sampling.
